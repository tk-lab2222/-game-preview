...
function late271(){render271();[80,220].forEach(ms=>setTimeout(render271,ms))}
...
.rareHiddenBonus271{margin-top:6px;padding:6px;border:1px solid #a98be8;border-radius:8px;background:#f8f3ff}.rareHiddenBonus271>small{display:block;font-size:6px;font-weight:1000;color:#674a9c}.rareHiddenBonus271 .hidden271{margin-top:4px}.lineageSummary271{margin-top:0;padding:8px 9px;border:1px solid #ffffff24;border-radius:9px;background:#ffffff0c;color:#fff;display:grid;grid-template-columns:1fr auto;gap:4px 8px;font-size:7px}.lineageSummary271 b{font-size:8px}.lineageSummary271 span{font-weight:1000;color:#ffe17a}.lineageSummary271 small{grid-column:1/-1;color:#c8d6e6;line-height:1.45}`;document.head.appendChild(css);setTimeout(late271,0);
window.STAR_LINEAGE271={sync:render271,settle:late271};
})();