...
async function hatchCinematic350(m,{preview=false,batch=false}={}){
 ...
 el.innerHTML=`<div class="cinemaStorm350">
   <div class="cinemaCloud350"></div><div class="cinemaLightning350 l1"></div><div class="cinemaLightning350 l2"></div>
   <div class="cinemaDragon350"><div class="dragonHead350"></div><div class="dragonBody350"></div><div class="dragonTail350"></div></div>
...
.cinemaLightning350{position:absolute;top:-8%;width:5px;height:80%;background:#eafaff;box-shadow:0 0 8px #fff,0 0 22px #74dfff,0 0 40px #9f79ff;opacity:0;clip-path:polygon(45% 0,100% 0,62% 42%,94% 42%,20% 100%,42% 56%,10% 56%)}.l1{left:25%;transform:rotate(8deg)}.l2{right:22%;transform:rotate(-10deg)}.phaseStorm350 .l1{animation:bolt350 2.2s .25s infinite}.phaseStorm350 .l2{animation:bolt350 2.7s .8s infinite}@keyframes bolt350{0%,88%,100%{opacity:0}89%,92%{opacity:1}93%{opacity:.15}94%,96%{opacity:1}}
.cinemaDragon350{position:absolute;left:50%;top:23%;width:280px;height:180px;transform:translate(-50%,-10%) scale(.65);opacity:0;filter:drop-shadow(0 0 16px #6feaff) drop-shadow(0 0 28px #9873ff)}.phaseDragon350 .cinemaDragon350{animation:dragonIn350 1.4s ease-out forwards}@keyframes dragonIn350{to{opacity:.72;transform:translate(-50%,0) scale(1)}}.dragonBody350{position:absolute;left:68px;top:64px;width:150px;height:54px;border:6px solid #aeeeff;border-left-color:transparent;border-radius:55% 48% 50% 52%;transform:rotate(-8deg)}.dragonHead350{position:absolute;left:34px;top:38px;width:68px;height:54px;border:6px solid #d9f9ff;border-radius:60% 45% 55% 45%;transform:rotate(-14deg)}.dragonHead350:before,.dragonHead350:after{content:'';position:absolute;top:-35px;width:8px;height:42px;background:#c8f5ff;clip-path:polygon(50% 0,100% 100%,0 100%)}.dragonHead350:before{left:12px;transform:rotate(-18deg)}.dragonHead350:after{right:12px;transform:rotate(20deg)}.dragonTail350{position:absolute;right:-6px;top:85px;width:92px;height:8px;border-radius:99px;background:linear-gradient(90deg,#aeeeff,transparent);transform:rotate(18deg);transform-origin:left}
