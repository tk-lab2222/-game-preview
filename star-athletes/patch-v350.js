...
function athleteView350(m){
 return `<div class="godAthlete350">
  <div class="godAthletePrism350"></div>
  <div class="godAthleteAurora350"></div>
  <div class="godAthleteSky350"></div>
  <div class="godAthleteSweep350"></div>
  <div class="godAthleteOrbit350 orbitA350"><i></i><i></i><i></i></div>
  <div class="godAthleteOrbit350 orbitB350"><i></i><i></i></div>
...
async function hatchCinematic350(m,{preview=false,batch=false}={}){
 ...
 el.innerHTML=`<div class="cinemaStorm350">
   ...
   <svg class="cinemaLightningSvg350" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
    <path class="boltA350" d="M27 -4 L22 16 L29 14 L19 34 L25 32 L14 57 L21 53 L11 78 L17 75 L10 104"/>
    <path class="boltB350" d="M73 -4 L78 15 L71 13 L82 34 L75 31 L87 55 L80 52 L90 76 L83 73 L91 104"/>
   </svg>
 ...
 await sleep350(160);
 if(window.STAR_SHARE351){
   const share=document.createElement('button');share.className='cinemaShare350';share.textContent='↗ この神星を共有';
   share.onclick=()=>window.STAR_SHARE351.open(m);el.appendChild(share);
 }
 if(!preview){
...
.godAthlete350{position:relative;width:min(390px,94vw);min-height:520px;border:2px solid #d7b04b;border-radius:24px;overflow:hidden;background:radial-gradient(circle at 50% 18%,#fff6b6 0,#dff8ff 18%,#edddff 38%,#161d36 70%,#070a12);box-shadow:0 0 0 1px #fff6 inset,0 0 35px #ffe06f55,0 0 70px #9c74ff55,0 24px 70px #000b;animation:godFramePulse350 4.8s ease-in-out infinite}@keyframes godFramePulse350{0%,100%{box-shadow:0 0 0 1px #fff6 inset,0 0 30px #ffe06f4d,0 0 62px #9c74ff44,0 24px 70px #000b}50%{box-shadow:0 0 0 1px #fff9 inset,0 0 48px #ffe06f88,0 0 88px #78eaff55,0 24px 70px #000b}}.godAthletePrism350{position:absolute;z-index:1;inset:0;border-radius:22px;pointer-events:none;background:linear-gradient(118deg,transparent 0 12%,#ff6f9130 20%,#ffd86a38 29%,#86ffad30 38%,#67eaff38 48%,#7796ff34 58%,#d77cff38 68%,transparent 79%);background-size:220% 100%;mix-blend-mode:screen;opacity:.55;animation:prismFlow350 7.5s ease-in-out infinite}@keyframes prismFlow350{0%,100%{background-position:0% 50%;opacity:.38}50%{background-position:100% 50%;opacity:.68}}.godAthlete350:after{content:'';position:absolute;z-index:8;inset:-2px;border-radius:24px;padding:2px;background:conic-gradient(from 0deg,#ff7690,#ffd66b,#8dffad,#6eeeff,#7b94ff,#d784ff,#ff7690);background-size:100% 100%;-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask-composite:exclude;pointer-events:none;opacity:.62;animation:prismBorder350 9s linear infinite}@keyframes prismBorder350{to{filter:hue-rotate(360deg)}}.godAthleteAurora350{position:absolute;inset:-28%;background:conic-gradient(from 20deg,transparent 0 10%,#ff7e9d20 16%,#ffd96f22 23%,#7dffb620 30%,#71efff28 38%,transparent 47% 55%,#7e91ff22 64%,#d783ff28 73%,transparent 83% 100%);filter:blur(18px);animation:aurora350 18s linear infinite}@keyframes aurora350{to{transform:rotate(360deg)}}.godAthleteSky350{position:absolute;inset:-30px 0;background:radial-gradient(circle,#fff 0 1px,transparent 1.8px) 0 0/42px 42px,radial-gradient(circle,#ffe16f 0 1px,transparent 1.8px) 17px 26px/61px 61px;opacity:.65;animation:sky350 11s linear infinite}@keyframes sky350{to{transform:translateY(-34px)}}.godAthleteSweep350{position:absolute;z-index:2;top:-25%;left:-65%;width:38%;height:150%;transform:rotate(18deg);background:linear-gradient(90deg,transparent,#fff8d000,#fffbdc8c,#b9f4ff42,#fff0);filter:blur(5px);animation:sweep350 6.5s ease-in-out infinite}@keyframes sweep350{0%,35%{left:-65%;opacity:0}45%{opacity:.75}65%{left:130%;opacity:.4}70%,100%{left:130%;opacity:0}}.godAthleteOrbit350{position:absolute;z-index:2;left:50%;top:56px;border:1px solid #ffffff24;border-radius:50%;pointer-events:none}.orbitA350{width:292px;height:292px;margin-left:-146px;animation:orbit350 16s linear infinite}.orbitB350{width:230px;height:230px;margin-left:-115px;top:88px;animation:orbit350 11s linear infinite reverse}@keyframes orbit350{to{transform:rotate(360deg)}}.godAthleteOrbit350 i{position:absolute;width:5px;height:5px;border-radius:50%;background:#fff8b2;box-shadow:0 0 7px #fff,0 0 14px #ffe26d}.godAthleteOrbit350 i:nth-child(1){left:50%;top:-3px}.godAthleteOrbit350 i:nth-child(2){right:8%;top:68%}.godAthleteOrbit350 i:nth-child(3){left:7%;top:28%}.godAthleteRing350{position:absolute;left:50%;top:62px;width:260px;height:260px;transform:translateX(-50%);border:2px solid #ffe16f88;border-radius:50%;box-shadow:0 0 25px #ffe16f55,inset 0 0 22px #8befff44;animation:ring350 13s linear infinite}@keyframes ring350{to{transform:translateX(-50%) rotate(360deg)}}.godAthleteRing350:before,.godAthleteRing350:after{content:'';position:absolute;border-radius:50%;border:1px solid #8befff77;inset:20px}.godAthleteRing350:after{inset:42px;border-color:#d8a0ff77}.godAthleteArt350{position:relative;z-index:4;height:330px;margin-top:36px}.godAthleteArt350 .avatar,.godAthleteArt350 .bigArt{height:330px!important;width:100%!important;border:0!important;background:transparent!important;overflow:visible!important}.godAthleteArt350 .dracoCanvas,.godAthleteArt350 .speciesCanvas{z-index:5!important;display:block!important;opacity:1!important}.godAthleteBase350{position:absolute;z-index:3;left:50%;top:330px;width:210px;height:55px;transform:translateX(-50%);border-radius:50%;background:radial-gradient(ellipse,#fffbd1,#c8efff99 42%,#9c74ff55 65%,transparent 78%);filter:blur(1px);box-shadow:0 0 28px #ffe16f66}.godAthleteName350{position:relative;z-index:6;text-align:center;margin-top:4px}.godAthleteName350 small,.godAthleteName350 b{display:block}.godAthleteName350 small{font-size:7px;letter-spacing:.2em;color:#ffe581;animation:starLabel350 3.8s ease-in-out infinite}@keyframes starLabel350{0%,78%,100%{text-shadow:0 0 4px #ffe16f66}84%{text-shadow:0 0 5px #fff,0 0 16px #fff,0 0 28px #ffe16f}}.godAthleteName350 b{font-size:25px;margin-top:3px;text-shadow:0 0 10px #fff,0 0 20px #a774ff}.godAthleteTraits350{position:relative;z-index:6;display:flex;flex-wrap:wrap;justify-content:center;gap:6px;padding:10px 14px 15px}.godAthleteTraits350 span{padding:5px 8px;border-radius:999px;border:1px solid #ffffff44;background:#ffffff12;font-size:7px;font-weight:1000}.cinemaClose350{position:fixed;z-index:100210;left:50%;bottom:max(20px,env(safe-area-inset-bottom));transform:translateX(-50%);border:1px solid #ffffff55;border-radius:999px;background:#14182bcc;color:#fff;padding:9px 22px;font-size:9px;font-weight:1000}.cinemaShare350{position:fixed;z-index:100211;left:50%;bottom:max(66px,calc(env(safe-area-inset-bottom) + 66px));transform:translateX(-50%);border:1px solid #ffe06f99;border-radius:999px;background:linear-gradient(90deg,#315a76dd,#59437cdd);color:#fff4a6;padding:9px 18px;font-size:8px;font-weight:1000;box-shadow:0 0 18px #9b73ff55}.phaseLeave350{opacity:0;transition:.45s}
