...
async function hatchCinematic350(m,{preview=false,batch=false}={}){
 ...
 el.innerHTML=`<div class="cinemaStorm350">
   ...
   <svg class="cinemaLightningSvg350" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
    ...
    <path class="branchA350" d="M23 28 L12 42 L18 43 L8 58"/>
    <path class="boltB350" d="M73 0 L77 19 L70 22 L81 41 L75 43 L84 68 L78 68 L85 100"/>
    <path class="branchB350" d="M76 26 L88 39 L82 42 L93 55"/>
   </svg>
...
.cinemaLightningSvg350{position:absolute;inset:-2% 0 0;width:100%;height:78%;overflow:visible;filter:drop-shadow(0 0 4px #fff) drop-shadow(0 0 12px #7eeaff) drop-shadow(0 0 20px #8f7dff);opacity:.95}.cinemaLightningSvg350 path{fill:none;stroke:#ecfbff;stroke-width:.7;stroke-linecap:round;stroke-linejoin:round;opacity:0}.cinemaLightningSvg350 .branchA350,.cinemaLightningSvg350 .branchB350{stroke-width:.42}.phaseStorm350 .boltA350{animation:boltPath350 2.6s .15s infinite}.phaseStorm350 .branchA350{animation:boltPath350 2.6s .2s infinite}.phaseStorm350 .boltB350{animation:boltPath350 3.1s .75s infinite}.phaseStorm350 .branchB350{animation:boltPath350 3.1s .8s infinite}@keyframes boltPath350{0%,84%,100%{opacity:0}85%{opacity:.2}87%{opacity:1}89%{opacity:.12}91%{opacity:.95}94%{opacity:0}}
