...
function grade223(m){const luck=hiddenRank223(m,'luck',2),r=Math.random(),ultra=.04+luck*.004,big=.18+luck*.008,bad=Math.max(.06,.12-luck*.008);return r<bad?['不調',.25]:r<bad+(1-bad-big-ultra)?['成功',1]:r<1-ultra?['大成功',1.65]:['超成功',2.5]}
