...
function renderMeetChoices125(){
 ...
 old.querySelectorAll('[data-pick125]').forEach(b=>b.onclick=()=>{const i=+b.dataset.pick125,m=list[i],t=tierFor125(i,list.length);S.seasonMeet={name:m[0],place:m[1],weather:m[2],events:[...m[3]]};S.meetChoice225=t.id;S.schedule=[...m[3]];S.assign={};S.strat={};S.rivals225=[];S.rivalsPromo225=false;render();});
}
