...
function advanceSeason233(){recordSeason233();const next=clamp233((n233(S.season)||1)+1,1,6);S.season=next;S.turn=0;S.plans={};S.assign={};S.strat={};S.schedule=[];S.seasonMeet=null;S.rivals225=[];S.rivalsPromo225=false;S.promotionPending=false;S.meetChoice225='standard';try{makeSchedule()}catch(_){}save233();location.replace(location.pathname+'?season='+next+'&t='+Date.now())}
