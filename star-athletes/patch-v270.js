...
function renderCandidate270(){
 ...
 host.querySelector('.roleLegend270')?.remove();const lead=document.createElement('div');lead.className='roleLegend270';lead.innerHTML='<b>ROLE SCOUT</b><span>🏆 大会選手</span><span>🧬 配合親</span><span>🌱 将来性</span>';const hint=host.querySelector('.cmpHint262');(hint||host.firstChild)?.after?.(lead);
