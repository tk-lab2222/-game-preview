...
function clean253(){let changed=false;for(const m of all253()){if(!m)continue;if(m.rarityPotential253){delete m.rarityPotential253;changed=true}if(m.rarityStat252){delete m.rarityStat252;changed=true}if(!m.abilityRankFinal340&&m.rarity!=='C'){m.rarity='C';changed=true}}if(changed)persist253()}
